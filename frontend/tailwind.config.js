...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Custom color palette for RouteX
        primary: {
          50: '#f5f3ff',
          100: '#ede9fe',
          200: '#ddd6fe',
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgb(124 58 237), 0 0 10px rgb(124 58 237), 0 0 15px rgb(124 58 237)' },
          '100%': { boxShadow: '0 0 10px rgb(124 58 237), 0 0 20px rgb(124 58 237), 0 0 30px rgb(124 58 237)' },
        },
      },
      backdropBlur: {
        xs: '2px',
